...
LOCAL_WHISPER_MODEL = os.getenv(
    "WHISPER_MODEL_NAME",
    "/home/nisha/whisper-large-v3-hf",
)
...
def convert_to_ct2(
    ...
    print("which:", shutil.which("ct2-transformers-converter"))    
...
def parse_args():
    ...
    default=os.getenv(
        ...
        "./whisper-medical-lora/exported_best",
    ...
    parser.add_argument(
        ...
        "WHISPER_MERGED_DIR",
        "./whisper-medical-lora/merged_hf",
),
    ...
    parser.add_argument(
        ...
        default=os.getenv(
     "WHISPER_CT2_DIR",
    "./whisper-medical-lora/ct2_model",
),
